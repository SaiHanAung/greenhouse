                ...
                <div class="tab-panels">
                            ...
                            <div class="products-create-tabs-inner-content max-width-content">
                                <div class="ant-row ant-row-no-wrap" style="margin-left: -16px; margin-right: -16px; row-gap: 0px;">
                                    <div class="ant-col ant-col-12 product-details-info-col" style="padding-left: 16px; padding-right: 16px;">
                                        <div class="product-details-row">
                                            <div class="ant-row" style="margin-left: -4px; margin-right: -4px; row-gap: 0px;">
                                                <div class="ant-col ant-col-12" style="padding-left: 4px; padding-right: 4px;">
                                                    <div class="form-item">
                                                        <div class="form-item-title">Hardware</div>
                                                        <div class="form-item-content offset-sm">ESP32</div>
                                                    </div>
                                                </div>
                                                <div class="ant-col ant-col-12" style="padding-left: 4px; padding-right: 4px;">
                                                    <div class="form-item">
                                                        <div class="form-item-title">Connection Type</div>
                                                        <div class="form-item-content offset-sm">WiFi</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ant-row product-details-row" style="margin-left: -4px; margin-right: -4px; row-gap: 0px;">
                                            <div class="ant-col ant-col-12" style="padding-left: 4px; padding-right: 4px;">
                                                <div class="form-item">
                                                    <div class="form-item-title">Manufacturer</div>
                                                    <div class="form-item-content offset-sm">My organization 9894WM</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ant-row product-details-row" style="row-gap: 0px;">
                                            <div class="ant-col ant-col-12">
                                                <div class="form-item">
                                                    <div class="form-item-title">Offline Ignore Period</div>
                                                    <div class="form-item-content offset-sm">0 hrs 0 mins 0 secs</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-details-row">
                                            <div class="ant-row row" style="margin-left: -16px; margin-right: -16px; row-gap: 0px;">
                                                <div class="ant-col ant-col-24" style="padding-left: 16px; padding-right: 16px;">
                                                    <div class="form-item">
                                                        <div class="form-item-title">Template Ids</div>
                                                        <div class="form-item-content offset-sm">
                                                            <div class="product-details-template-id">TMPLBT6l8dwE<span class="linearicon linearicon-copy undefined"></span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="product-details-row">
                                            <div class="ant-row row" style="margin-left: -16px; margin-right: -16px; row-gap: 0px;">
                                                <div class="ant-col ant-col-24" style="padding-left: 16px; padding-right: 16px;">
                                                    <div class="form-item">
                                                        <div class="form-item-title">Categories</div>
                                                        <div class="form-item-content offset-sm">Other</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-details-row">
                                            <div class="ant-row row" style="margin-left: -16px; margin-right: -16px; row-gap: 0px;">
                                                <div class="ant-col ant-col-24" style="padding-left: 16px; padding-right: 16px;">
                                                    <div class="form-item">
                                                        <div class="form-item-title">Description</div>
                                                        <div class="form-item-content offset-sm"><span>This is my template<br></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-details-row">
                                            <div class="form-item">
                                                <div class="form-item-content">
                                                    <div class="ant-row ant-row-middle" style="row-gap: 0px;">
                                                        <div class="ant-col"><button type="button" role="switch" aria-checked="false" disabled="" class="ant-switch ant-switch-small ant-switch-disabled">
                                                                <div class="ant-switch-handle"></div><span class="ant-switch-inner"></span>
                                                            </button></div>
                                                        <div class="ant-col"><span class="switch-label">Show map in device view</span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="ant-col ant-col-12" style="padding-left: 16px; padding-right: 16px;">
                                        <div class="product-details-row product-details-image"><img src="https://static-image.nyc3.cdn.digitaloceanspaces.com/general/default_template.png" alt="Logo"></div>
                                        <div class="form-item">
                                            <div class="form-item-title">Firmware configuration</div>
                                            <div class="form-item-content">
                                                <div class="template-code-editor-copyable">
                                                    <div class="template-code-editor" style="position: relative; text-align: left; box-sizing: border-box; padding: 0px; overflow: hidden; font-size: 14px;"><textarea class="npm__react-simple-code-editor__textarea template-code-editor-textarea" id="template-code-editor" readonly="" autocapitalize="off" autocomplete="off" autocorrect="off" spellcheck="false" data-gramm="false" style="margin: 0px; border: 0px; background: none; box-sizing: inherit; display: inherit; font-family: inherit; font-size: inherit; font-style: inherit; font-variant-ligatures: inherit; font-weight: inherit; letter-spacing: inherit; line-height: inherit; tab-size: inherit; text-indent: inherit; text-rendering: inherit; text-transform: inherit; white-space: pre-wrap; word-break: keep-all; overflow-wrap: break-word; position: absolute; top: 0px; left: 0px; height: 100%; width: 100%; resize: none; color: inherit; overflow: hidden; -webkit-font-smoothing: antialiased; -webkit-text-fill-color: transparent; padding: 8px;">#define BLYNK_TEMPLATE_ID "TMPLBT6l8dwE"
                                                        #define BLYNK_DEVICE_NAME "s"</textarea>
                                                        <pre class="template-code-editor-pre" aria-hidden="true" style="margin: 0px; border: 0px; background: none; box-sizing: inherit; display: inherit; font-family: inherit; font-size: inherit; font-style: inherit; font-variant-ligatures: inherit; font-weight: inherit; letter-spacing: inherit; line-height: inherit; tab-size: inherit; text-indent: inherit; text-rendering: inherit; text-transform: inherit; white-space: pre-wrap; word-break: keep-all; overflow-wrap: break-word; position: relative; pointer-events: none; padding: 8px;"><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">define</span> <span class="token expression">BLYNK_TEMPLATE_ID </span><span class="token string">"TMPLBT6l8dwE"</span></span>
                                                        <span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">define</span> <span class="token expression">BLYNK_DEVICE_NAME </span><span class="token string">"s"</span></span><br></pre>
                                                        <style type="text/css">
                                                            /**
                                                ...
                                                </div><span>Template ID and Device Name should be included at the top of your main&nbsp;firmware</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section id="rauchbier" class="tab-panel">
                        ...
                        <div class="worko-tabs">
                            ...
                            <input class="state" type="radio" title="tab-four" name="tabs-state" id="tab-four" checked />
                            ...
                            <div class="tabs flex-tabs">
                                ...
                                <label for="tab-five" id="tab-five-label" class="tab">รายงาน</label>
                                <style>
                                    .width-border {
                                        max-width: 100%;
                                        width: 100%;
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="width-border">
                                                ...
                                                <p class="ml-4">อัพเดทล่าสุด : 0000-00-00 00:00:00</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="width-border">
                                ...
                                <div id="tab-two-panel" class="panel">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="width-border">
                                                <h4 class="m-3">Profile 1 : พ่นน้ำ</h4>
                                                ...
                                                <div id="drop-stop">
                                                    <div class="row">
                                                        <div class="center">
                                                            <h3 class="mt-2">สถานะ : หยุดการทำงาน</h3>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="center">
                                        ...
                                        <div class="bt-g-br">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="bt-last">
                                                    ...
                                                    <button type="submit" class="bt-create ml-2"><img src="../imgs/plus.png" class="plus" width="18%" alt="icon"><img src="../imgs/plus-green.png" class="plus-hover" width="18%" alt="icon"> สร้าง</button>
                                                    <button type="submit" class="bt-edit ml-2"><img src="../imgs/edit-white.png" class="edit" width="25%" alt="icon"><img src="../imgs/edit-gray.png" class="edit-hover" width="25%" alt="icon"> แก้ไข</button>
                                                    <button type="submit" class="bt-delete ml-2"><img src="../imgs/trash-white.png" class="trash" width="20%" alt="icon"><img src="../imgs/trash-dark.png" class="trash-hover" width="20%" alt="icon"> ลบ</button>
                                                    <script>
                                                        $(document).ready(function() {
                                        ...
                                        <div class="col-sm-6">
                                            <div class="width-border">
                                                ...
                                                <div class="ant-row mt-3">
                                                    <div class="col-md-6" style="display: flex; right:0%;">
                            ...
                            <div class="ant-row ant-row-no-wrap" style="overflow: auto; margin: 0px; row-gap: 0px;">
                                <div class="ant-col">
                                    <div class="user-details-row">
                                        <div class="col-sm-4 rounder-border">
                                            <div class="row mb-2">
                                                <button type="button" class="ant-btn ant-btn-secondary"><span>ปัจจัยการผลิตสำหรับฟาร์มเกษตรอินทรีย์ ( ชนิด / แหล่งที่มา )</span></button>
                                            </div>
                                            <div class="row mb-2">
                                                <button type="button" class="ant-btn ant-btn-secondary"><span>การใช้ปัจจัยการผลิตสำหรับฟาร์มเกษตรอินทรีย์</span></button>
                                            </div>
                                            <div class="row mb-2">
                                                <button type="button" class="ant-btn ant-btn-secondary"><span>การเก็บเกี่ยวผลผลิตเกษตรอินทรีย์</span></button>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="content-center">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nam at pariatur impedit autem labore, dolore reprehenderit, fugit assumenda voluptatibus vel laborum similique adipisci, veniam placeat? Enim optio nesciunt ea rerum.</div>
                                        </div>
                                        <div class="form-item">
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="bt-last">
                                    <style>
                                        ...
                                        .bt-create-farm-record:hover .plus {
                                            display: none;
                                        }
                                        ...
                                        .bt-create-farm-record:hover .plus-hover {
                                            opacity: 1;
                                            position: relative;
                                            font-weight: bold;
                                        }
                                    ...
                                    <button type="submit" class="bt-create-farm-record ml-2"><img src="../imgs/plus.png" class="plus" width="18%" alt="icon"><img src="../imgs/plus-green.png" class="plus-hover" width="18%" alt="icon"> สร้าง</button>
                                    <button type="submit" class="bt-edit ml-2"><img src="../imgs/edit-white.png" class="edit" width="25%" alt="icon"><img src="../imgs/edit-gray.png" class="edit-hover" width="25%" alt="icon"> แก้ไข</button>
                                    <button type="submit" class="bt-delete ml-2"><img src="../imgs/trash-white.png" class="trash" width="20%" alt="icon"><img src="../imgs/trash-dark.png" class="trash-hover" width="20%" alt="icon"> ลบ</button>
                                    <script>
                                        $(document).ready(function() {
