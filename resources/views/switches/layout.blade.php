...
<body>
    <div class="content">
        <div id="app">
            ...
            <script>
                $(document).ready(function() {
                    $('#openFormCreateSwitchOnMobile').click(function() {
                        $('.modal-mobile').show();
                    });
                    $('#cancelFormCreateSwitchOnMobile').click(function() {
                        $('.modal-mobile').hide();
                    });
                });
            </script>
                                ...
                                <div class="ant-modal">
                                    <div class="ant-modal-content">
                                        ...
                                        <div class="ant-modal-body" id="FarmInputRecordTypeAndSourceShow">
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="ant-form-item ant-form-item-with-help own-custom-form-field normal-offset normal-offset ant-form-item-has-success">
                                        ...
                                        <div class="ant-modal-footer">
                                            <div class="row">
                                                <div class="col-8">
                                                    <button type="button" class="ant-btn ant-btn-secondary" id="cancelFormCreateSwitchOnMobile" ant-click-animating-without-extra-node="false">
                                                        <span>ยกเลิก</span>
                                                    </button>
