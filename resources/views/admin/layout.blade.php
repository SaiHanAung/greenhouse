...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#openViewPlot').click(function() {
                $('.viewPlot').show();
            });
            $('#cancelViewPlot').click(function() {
                $('.viewPlot').hide();
            });

            // $('#openFormEditPassword').click(function() {
            //     $('.formEditPassword').show();
            // });
            $('#cancelFormEditPassword').click(function() {
...
<body>
    <button id="back-to-top-btn"><i class="fas fa-angle-double-up text-center">123</i></button>
    <div class="content">
        <div id="app">
            @if(Auth::check())
            <?php
                            ...
                            <div class="user-layout-left-navigation-stack user-layout-left-navigation-stack-fold">
                                <div class="user-layout-left-navigation  user-layout-left-navigation-fold">
                                    ...
                                    <ul class="ant-menu ant-menu-root ant-menu-vertical ant-menu-light user-layout-left-navigation-menu ant-menu-inline-collapsed">
                                        <li class="ant-menu-item ant-menu-item-selected" data-toggle="tooltip" data-placement="right" title="จัดการผู้ใช้"><span class="ant-menu-title-content"><a href="{{ route('admin.index') }}"></a><span class="linearicon linearicon-grid2 undefined"></span><span>ฟาร์ม</span></span></li>
                            ...
                            <div class="ant-modal-content">
                                ...
                                <div class="ant-modal-body">
                                    ...
                                    <div class="ant-row ant-form-item ant-form-item-with-help own-custom-form-field normal-offset normal-offset ant-form-item-has-success" style="row-gap: 0px;">
                                        <div class="font-prompt">ขนาดแปลง 
                                        ...
                                        <div class="ant-col ant-col-12" style="padding-left: 4px; padding-right: 4px;">
                                            <div class="ant-row ant-form-item normal-offset undefined" style="row-gap: 0px;">
                                                ...
                                                <div class="ant-col ant-form-item-control">
                                                    <div class="ant-form-item-control-input">
                                                        <div class="ant-form-item-control-input-content">
                                                            <input class="font-prompt" type="file" name="img_name" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="viewPlot" style="display: none;">
                <div class="ant-modal-mask"></div>
                <div class="ant-modal-wrap ant-modal-centered">
                    <div class="ant-modal">
                        <div class="ant-modal-content">
                            <div class="ant-modal-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="bt-last">
                                            <button type="button" id="cancelViewPlot" class="btn-secondary btn-sm">X</button>
                                        </div>
                                    </div>
                                </div>
                                </div>
                            ...
                            <div class="ant-modal-body">
                                @php $i = 0; @endphp
                                <div class="ant-row ant-form-item ant-form-item-with-help own-custom-form-field normal-offset normal-offset ant-form-item-has-success" style="row-gap: 0px;">
                                    <div class="font-prompt">แปลงที่ {{++$i}}
