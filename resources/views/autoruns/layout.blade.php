...
<head>
    ...
    <link href="{{ asset('css/plot/modal_createautorun.css') }}" rel="stylesheet">
...
<body>
    <div class="content">
        <div id="app">
            ...
            <div class="ant-modal-root-2" style="display: none;">
                <form action="{{ route('autorun.store') }}" method="POST" name="form1">
                    @csrf
                            ...
                            <div class="ant-modal-content">
                                ...
                                <div class="ant-modal-body">
                                    <div class="ant-form ant-form-horizontal">
                                        <div class="ant-row ant-form-item ant-form-item-with-help own-custom-form-field normal-offset normal-offset ant-form-item-has-success" style="row-gap: 0px;">
                                            ...
                                            <div class="ant-col ant-form-item-control">
                                                <div class="ant-form-item-control-input">
                                                    <div class="ant-form-item-control-input-content"><input placeholder="Name" name="name" type="text" class="ant-input" required></div>
                                                </div>
                                                    ...
                                                    <div class="ant-form-item-control-input-content">
                                                        <div class="zones-select">
                                                            <label class="containers"><span>1</span>
                                                                <input type="radio" name="work_zone" value="zone1">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <label class="containers"><span>2</span>
                                                                <input type="radio" name="work_zone" value="zone2">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <label class="containers"><span>3</span>
                                                                <input type="radio" name="work_zone" value="zone3">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <label class="containers"><span>4</span>
                                                                <input type="radio" name="work_zone" value="zone4">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <label class="containers"><span>5</span>
                                                                <input type="radio" name="work_zone" value="zone5">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <label class="containers"><span>6</span>
                                                                <input type="radio" name="work_zone" value="zone6">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <label class="containers"><span>7</span>
                                                                <input type="radio" name="work_zone" value="zone7">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                            <label class="containers"><span>8</span>
                                                                <input type="radio" name="work_zone" value="zone8">
                                                                <span class="checkmark"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="ant-row" style="margin-left: -4px; margin-right: -4px; row-gap: 0px;">
                                            <div class="ant-col ant-col-12" style="padding-left: 4px; padding-right: 4px;">
                                                <div class="ant-row ant-form-item normal-offset undefined" style="row-gap: 0px;">
                                                    <div class="ant-col ant-form-item-label"><label>เวลาเริ่มต้นทำงาน</label></div>
                                                    <div class="ant-col ant-form-item-control">
                                                        <input type="time" class="input-time" name="start_time" value="08:00" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="ant-col ant-col-12" style="padding-left: 4px; padding-right: 4px;">
                                                <div class="ant-row ant-form-item normal-offset undefined" style="row-gap: 0px;">
                                                    <div class="ant-col ant-form-item-label"><label>เวลาหยุดทำงาน</label></div>
                                                    <div class="ant-col ant-form-item-control">
                                                        <input type="time" class="input-time" name="stop_time" value="08:30" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ant-col ant-form-item-label mb-2"><label>ทำซ้ำ</label></div><br />
                                        <label class="containers mb-3">
                                            <span>ทุกวัน</span>
                                            <input type="radio" name="repeat" value="1" onclick="selectAll(form1)">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="containers mb-3">
                                            <span>ไม่ทำซ้ำ</span>
                                            <input type="radio" name="repeat" value="0" onclick="selectAll(form1)">
                                            <span class="checkmark"></span>
                                        </label><br />
                                        ...
                                        <input type="radio" name="sunday" value="0" style="display: none;">

                                        <label class="containers"><span>จันทร์</span>
                                            <input type="radio" name="monday" value="1">
                                            <span class="checkmark"></span>
                                        </label>
                                        <input type="radio" name="monday" value="0" style="display: none;">

                                        <label class="containers"><span>อังคาร</span>
                                            <input type="radio" name="tuesday" value="1">
                                            <span class="checkmark"></span>
                                        </label>
                                        <input type="radio" name="tuesday" value="0" style="display: none;">

                                        <label class="containers"><span>พุธ</span>
                                            <input type="radio" name="wednesday" value="1">
                                            <span class="checkmark"></span>
                                        </label>
                                        <input type="radio" name="wednesday" value="0" style="display: none;">

                                        <label class="containers"><span>พฤหัสบดี</span>
                                            <input type="radio" name="thursday" value="1">
                                            <span class="checkmark"></span>
                                        </label>
                                        <input type="radio" name="thursday" value="0" style="display: none;">

                                        <label class="containers"><span>ศุกร์</span>
                                            <input type="radio" name="friday" value="1">
                                            <span class="checkmark"></span>
                                        </label>
                                        <input type="radio" name="friday" value="0" style="display: none;">

                                        <label class="containers"><span>เสาร์</span>
                                            <input type="radio" name="saturday" value="1">
                                            <span class="checkmark"></span>
                                        </label>
                                        <input type="radio" name="saturday" value="0" style="display: none;">
                                        <br />
                                        <br />
                                    </div>
                ...
                <script type="text/javascript">
                    function selectAll(form1) {
                        ...
                        var check = document.getElementsByName("repeat"),
    ...
    <script>
        $(document).ready(function() {
            $('#openFormCreateAuto').click(function() {
